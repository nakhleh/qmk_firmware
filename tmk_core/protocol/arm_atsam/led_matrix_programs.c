...
void *led_setups[] = {leds_green, leds_teal_salmon, leds_yellow, leds_red, leds_blue, leds_white, leds_rainbow_s, leds_rainbow_ns, leds_white_with_red_stripe, leds_black_with_red_stripe, leds_off};
