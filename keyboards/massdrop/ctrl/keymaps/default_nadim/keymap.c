...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_P7,   KC_P8,   KC_P9, _______, _______,   KC_MPLY, KC_MSTP, KC_VOLU, \
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, _______, U_T_AGCR,  KC_P4,   KC_P5,   KC_P6, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD, \
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, _______, _______, _______, _______,   KC_P1,   KC_P2,   KC_P3, _______, \
        _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, TG_NKRO, _______, _______,   KC_P0,   KC_P0, _______,                              _______, \
...
// Run on initialization and when lock state is changed
void led_set_keymap(uint8_t usb_led)
{
  // If there is no numlock key, then press it manually so it's enabled
  // See info - https://github.com/qmk/qmk_firmware/issues/2164
